...
void ZepWindow::UpdateScreenLines()
{
    ...
    while (visLine < windowLines.size())
    {
        ...
        if ((lineInfo.screenPosYPx + m_defaultLineSize) >= m_textRegion.bottomRightPx.y)
        {
            break;
        }
    }
