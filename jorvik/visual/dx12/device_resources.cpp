...
void DeviceResources::CreateDeviceResources() 
{
    ...
    // NOTE: Enabling the debug layer after device creation will invalidate the active device.
    {
        ...
        if (SUCCEEDED(DXGIGetDebugInterface1(0, IID_PPV_ARGS(dxgiInfoQueue.GetAddressOf()))))
        {
            ...
            // Don't break during broken shader compiles ;) Since we are a live shader tool.  Can set this to catch other things though!
    ...
    // Create context
    D3D12_DESCRIPTOR_HEAP_DESC fntDescriptorHeapDesc = {};
    fntDescriptorHeapDesc.Type = D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV;
    fntDescriptorHeapDesc.NumDescriptors = 1;
    fntDescriptorHeapDesc.Flags = D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE;
    ThrowIfFailed(m_d3dDevice->CreateDescriptorHeap(&fntDescriptorHeapDesc, IID_PPV_ARGS(m_fntDescriptorHeap.ReleaseAndGetAddressOf())));
    m_fntDescriptorHeap->SetName(L"FontHeap");
