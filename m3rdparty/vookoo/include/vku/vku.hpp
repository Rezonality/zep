...
public:
    ...
    DebugCallback(
        ...
        vk::DebugReportFlagsEXT flags = vk::DebugReportFlagBitsEXT::eWarning | vk::DebugReportFlagBitsEXT::eError)
        : instance_(instance)
    {
        auto ci = vk::DebugReportCallbackCreateInfoEXT{ flags, &debugCallback };

        auto vkCreateDebugReportCallbackEXT = (PFN_vkCreateDebugReportCallbackEXT)instance_.getProcAddr(
    ...
    void reset()
    {
        if (callback_)
        {
            auto vkDestroyDebugReportCallbackEXT = (PFN_vkDestroyDebugReportCallbackEXT)instance_.getProcAddr(
