...
struct ImGuiSettingsHandler
{
    ...
    void*       (*ReadOpenFn)(ImGuiContext* ctx, ImGuiSettingsHandler* handler, const char* name);              // Read: Called when entering into a new ini entry e.g. "[VkWindow][Name]"
...
struct IMGUI_API ImGuiWindow
{
    ...
    ImVec2                  WindowPadding;                      // VkWindow padding at the time of begin.
    float                   WindowRounding;                     // VkWindow rounding at the time of begin.
    float                   WindowBorderSize;                   // VkWindow border size at the time of begin.
